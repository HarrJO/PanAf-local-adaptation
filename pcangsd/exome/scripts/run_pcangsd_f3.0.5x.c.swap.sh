...
# Job name
#$ -N pcangsd_f3.0.5x.c.swap

# Set working directory
#$ -wd /home/ucfajos/Scratch/output/phase1and2_exome_output/pcangsd_output/mapped.on.target/f3.0.5x.c.swap_minInd.5_doMajorMinor.1_HWE.p.1e-3_snp.p.1e-6_minMAF.0.05
...
-beagle ${INDIR}/f3.0.5x.c.swap.beagle.gz \
-o c.swap/f3.0.5x.c.swap \
-threads 10
