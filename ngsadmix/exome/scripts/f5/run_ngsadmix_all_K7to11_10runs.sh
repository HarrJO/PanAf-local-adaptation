...
# Job name
#$ -N ngsadmix_f5.0.5x.all_K7to11_repeat.x10

# Set working directory
#$ -wd /home/ucfajos/Scratch/output/phase1and2_exome_output/ngsadmix_output/mapped.on.target/f5.0.5x.all_minInd.15_doMajorMinor.1_HWE.p.1e-3_snp.p.1e-6_minMAF.0.01
...
for K in {7..11}
	...
	for RUN in {1..10}
		...
		-likes ${INDIR}/f5.0.5x.all.beagle.gz \
		-K $K \
		-P 10 \
		-o f5.0.5x.all_K${K}_run${RUN} 
		done
	done
