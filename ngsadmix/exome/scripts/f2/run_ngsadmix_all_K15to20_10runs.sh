...
# Job name
#$ -N ngsadmix_f2.0.5x.all_K15to20_repeat.x10

# Set working directory
#$ -wd /home/ucfajos/Scratch/output/phase1and2_exome_output/ngsadmix_output/mapped.on.target/f2.0.5x.all_minInd.15_doMajorMinor.1_HWE.p.1e-3_snp.p.1e-6_minMAF.0.01
