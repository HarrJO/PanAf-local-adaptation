...
# Job name
#$ -N snpStat2coverage_chr21.py_chr21.f7.w.pops_minInd.6or50pct_missing.pops.0.3_minMAC2
...
-out_prefix chr21.f7.w.pops_chr21_missing.pops.0.3_pop_minMAC2 \
-snp_by_pop_file chr21.f7.w.pops_chr21_missing.pops.0.3_pop.allele.counts_minMAC2
