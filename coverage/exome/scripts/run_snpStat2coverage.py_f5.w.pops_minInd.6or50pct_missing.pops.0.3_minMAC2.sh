...
# Job name
#$ -N snpStat2coverage.py_f5.w.pops_minInd.6or50pct_missing.pops.0.3_minMAC2

# Set working directory
#$ -wd /home/ucfajos/Scratch/output/phase1and2_exome_output/allele.frequencies/mapped.on.target/f5.w.pops_minInd.6or50pct_missing.pops.0.3
...
-out_prefix f5.w.pops.all.chrs_missing.pops.0.3_minMAC2 \
-snp_by_pop_file f5.w.pops.all.chrs_missing.pops.0.3_pop.allele.counts_minMAC2
