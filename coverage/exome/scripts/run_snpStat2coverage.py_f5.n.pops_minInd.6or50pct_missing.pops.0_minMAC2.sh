...
# Job name
#$ -N snpStat2coverage.py_f5.n.pops_minInd.6or50pct_missing.pops.0_minMAC2
...
-out_prefix f5.n.pops.all.chrs_missing.pops.0_minMAC2 \
-snp_by_pop_file f5.n.pops.all.chrs_missing.pops.0_pop.allele.counts_minMAC2
