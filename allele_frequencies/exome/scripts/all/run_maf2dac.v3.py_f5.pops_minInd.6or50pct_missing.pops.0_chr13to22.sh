...
# Job name
#$ -N maf2dac.v3.py_f5.pops_minInd.6or50pct_missing.pops.0_chr13to22

# Set working directory
#$ -wd /home/ucfajos/Scratch/output/phase1and2_exome_output/allele.frequencies/mapped.on.target/f5.pops_minInd.6or50pct_missing.pops.0
