...
# Job name
#$ -N maf2dac.v3.py_f5.n.pops_minInd.6or50pct_missing.pops.0.3_chr13to22

# Set working directory
#$ -wd /home/ucfajos/Scratch/output/phase1and2_exome_output/allele.frequencies/mapped.on.target/f5.n.pops_minInd.6or50pct_missing.pops.0.3
