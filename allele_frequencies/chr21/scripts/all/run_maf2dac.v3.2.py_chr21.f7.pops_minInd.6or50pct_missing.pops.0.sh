...
# Job name
#$ -N maf2dac.v3.2.py_chr21.f7.pops_minInd.6or50pct_missing.pops.0

# Set working directory
#$ -wd /home/ucfajos/Scratch/output/phase1and2_chr21_output/allele.frequencies/chr21.f7.pops_minInd.6or50pct_missing.pops.0
